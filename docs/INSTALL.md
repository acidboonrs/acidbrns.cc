# Installation & Betrieb (ausführlich)

Detaillierte Installations-, Wartungs- und Troubleshooting-Anleitung für
**acidbrns.cc**. Schnellstart: [QUICKSTART.md](../QUICKSTART.md) ·
Architektur/Security: [ARCHITECTURE.de.md](../ARCHITECTURE.de.md) ·
